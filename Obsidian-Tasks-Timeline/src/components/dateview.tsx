                ...
                < TaskListContext.Consumer >{({ taskList, entryOnDate }) => {
                    ...
                    return (
                        <div>
                            ...
                            {
                                taskList.length > 0 && <div className={isToday ? "details taskido-today" : "details"}
                                    ...
                                    <div className={isToday ? "details taskido-today" : "details"}
                                        data-year={this.props.date.format("YYYY")}
                                        data-types={[...new Set(taskList.map((t => t.status)))].join(" ")}>
            ...
            <TaskListContext.Consumer>
                {({ taskList }) => (
                    <div className='content'>
                        {taskList.map((t, i) => <TaskItemView key={`${t.path}-${t.position.start.line}-${t.text}`} taskItem={t} />)}
                    </div>
                )}
            </TaskListContext.Consumer>
        )
